...
filename = rf"C:\Users\user\Desktop\course\專題\software\Node=1&Lane=1\GA_elitism_result\GA_elitism_{timestamp}.csv"
...
# --- GA 參數設定 ---
POP_SIZE = 200         # 每代要訓練幾組個體（幾組紅綠燈設定）
GEN_NUM = 10           # 總共進化幾代
TIME_MIN = 5            # 綠燈最短秒數
TIME_MAX = 100          # 綠燈最長秒數
...
for gen in range(GEN_NUM):
    ...
    worst_idx = tools.selWorst(offspring, 1)[0]     # 替換掉 offspring 中最差的
    offspring.remove(worst_idx)
